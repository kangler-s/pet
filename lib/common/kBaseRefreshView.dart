...
/// 初始化调用要延时加载
GlobalKey globalKeyRefresh = GlobalKey();
...
class BaseRefreshView extends StatefulWidget {
  ...
  @override
  State createState() => BaseRefreshViewState();
}

class BaseRefreshViewState extends State<BaseRefreshView> {
    ...
    if (widget.controller == null) {
      if (isLoadMore) {
        if (widget.onLoad != null) {
          _controller.finishLoad(widget.data.length == widget.limit
